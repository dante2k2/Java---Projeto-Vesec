			...
			try {
				...
				case "1":
					...
					if (vdao.adicionar(veiculo)) {
						JOptionPane.showConfirmDialog(null, "Veículo Cadastrado!", "", JOptionPane.DEFAULT_OPTION);
					} else {
				...
				case "2":
					...
					Veiculo veiculo2 = vdao.consulta(chassi);
					if(veiculo2 != null ){
				...
				case "3":
					chassi = JOptionPane.showInputDialog("Numeração do chassi do veículo: ");
					if (chassi == null) break;
					Veiculo veiculo3 = vdao.consulta(chassi);
					if(veiculo3 != null) {
						String opc2 = "";
				...
				case "4":
					chassi = JOptionPane.showInputDialog("Numeração do chassi do veículo: ");
					if (chassi == null) break;
					Veiculo veiculo4 = vdao.consulta(chassi);
					if(veiculo4 != null){
						if (vdao.remover(veiculo4)) {
							JOptionPane.showConfirmDialog(null, "Veículo Apagado!", "", JOptionPane.DEFAULT_OPTION);
						} else {
					...
					break;
				case "5":
					JOptionPane.showConfirmDialog(null, vdao.getLista(), "", JOptionPane.DEFAULT_OPTION);
					break;
				case "6":
					System.exit(0);
				default:
